                            ...
                            <asp:View ID="View1" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div style="overflow-x: auto; display: block;">
                                                <asp:GridView ID="grvStatus" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" OnPageIndexChanging="grvStatus_PageIndexChanging" PageSize="5" Width="100%">
                                                    <Columns>
                                                        <asp:BoundField DataField="Dependencia" HeaderText="Revisar"></asp:BoundField>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <asp:DropDownList ID="ddlNivel1" runat="server" ClientIDMode="Predictable" Width="100%" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <asp:DropDownList ID="ddlCiclo" runat="server" Width="100%" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <asp:DropDownList ID="ddlSubTipo1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSubTipo_SelectedIndexChanged" CssClass="form-control">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <asp:DropDownList ID="ddlStatus_Ini" runat="server" AutoPostBack="False" TabIndex="3" Width="100%" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-md-6">
                                            <asp:TextBox ID="txtReferencia" runat="server" CssClass="form-control" PlaceHolder="Nombre ó Matricula" TabIndex="4" Visible="true" Width="95%"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                                                                                        ...
                                                                                                        <table style="width: 100%;">
                                                                                                            <tr>
                                                                                                                <td class="auto-style76">
                                                                                                                    <asp:Label ID="lblHijo" runat="server" Text="Beneficiario(s):"></asp:Label></td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <asp:ImageButton ID="bttnNuevoHijo" runat="server" ImageUrl="https://sysweb.unach.mx/resources/imagenes/nuevo.png" OnClick="bttnNuevoHijo_Click" ValidationGroup="Nuevo Beneficiario" /></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                            ...
                                            <div class="card-deck">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">
                                                            <small class="text-muted">
                                                                <asp:Label ID="lblFechaAutorizado" runat="server"></asp:Label></small>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="card">
