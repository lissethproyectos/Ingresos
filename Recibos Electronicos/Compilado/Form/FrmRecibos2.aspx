<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmRecibos2.aspx.cs" Inherits="Recibos_Electronicos.Form.FrmRecibos2" %>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <asp:ImageButton ID="imgbtnBuscar" runat="server" 
                                            ImageUrl="https://sysweb.unach.mx/resources/imagenes/buscar.png" OnClick="imgbtnBuscar_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                                                ...
                                                                <td class="auto-style29" valign="top">
                                                                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <br />
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtValor_unitario" CssClass="MsjError" ErrorMessage="*Solo Números" ValidationExpression="\d+"></asp:RegularExpressionValidator>
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </td>
                                                                <td valign="top">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="5" width="35%">
                                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                            <ContentTemplate>
                                                                <asp:Button ID="btnGuardar_Concep_Continuar" runat="server" Cssclass="btn btn-blue-grey" onclick="btnGuardar_Concep_Continuar_Click" Text="GUARDAR Y CONTINUAR" ValidationGroup="guardar_conceptos" />
                                                                &nbsp;<asp:Button ID="btnGuardar_Concep" runat="server" CssClass="btn3" onclick="btnGuardar_Concep_Click" Text="GUARDAR Y SALIR" ValidationGroup="guardar_conceptos" />
                                ...
                                <tr>
                                    <td align="center" colspan="2" style="width: 100%" width="50%">
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                            <ContentTemplate>
                                                &nbsp;<asp:Button ID="btnGuardar" runat="server" Cssclass="btn btn-blue-grey" 
