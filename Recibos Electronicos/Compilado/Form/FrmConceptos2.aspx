<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FrmConceptos2.aspx.cs" Inherits="Recibos_Electronicos.Form.FrmConceptos2" %>
                                                ...
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="3">
                                                            <asp:Button ID="btnGuardar_C" runat="server" Cssclass="btn btn-blue-grey" Height="45px" onclick="btnGuardar_C_Click" Text="CLONAR" />
                                ...
                                <table style="width: 100%;" align="center">
                                    ...
                                    <tr>
                                        <td class="style23" align="center" colspan="8">
                                            <asp:Button ID="btnGuardar" runat="server" Cssclass="btn btn-blue-grey" Height="45px" Text="GUARDAR" TabIndex="15" ValidationGroup="guardar" 
