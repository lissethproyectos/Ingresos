<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmBanco.aspx.cs" Inherits="Recibos_Electronicos.frmBanco" %>
...
<table width="100%"  >
    <tr>
        ...
        <asp:Label ID="Label1" runat="server" Text="Aplica para archivos SANTANDER" CssClass="mgg_aviso mgg_aviso_verde"></asp:Label>
		...
		<div class="mgg_linea">
            ...
            <div class="mgg_col-gd-3">
                <asp:Button ID="bttnArchivo" runat="server" Text="Generar Archivo" OnClick="Enviar_Click" CssClass="mgg_enviar" OnClientClick="mostrar_spinner( )" />
            </div>			
		</div>
	</div>
        </td>
