...
namespace Recibos_Electronicos.Reportes {
    ...
    public class REP022_por_Carreras : ReportClass {
        
        public REP022_por_Carreras() {
        }
        
        public override string ResourceName {
            get {
                return "REP022_por_Carreras.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Recibos_Electronicos.Reportes.REP022_por_Carreras.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREP022_por_Carreras : Component, ICachedReport {
        
        public CachedREP022_por_Carreras() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            REP022_por_Carreras rpt = new REP022_por_Carreras();
            rpt.Site = this.Site;
            return rpt;
        }
