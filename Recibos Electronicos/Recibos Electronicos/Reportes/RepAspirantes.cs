...
namespace Recibos_Electronicos.Reportes {
    ...
    public class RepAspirantes : ReportClass {
        
        public RepAspirantes() {
        }
        
        public override string ResourceName {
            get {
                return "RepAspirantes.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Recibos_Electronicos.Reportes.RepAspirantes.rpt";
            }
            set {
                // Do nothing
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_P_UR {
            get {
    ...
    public class CachedRepAspirantes : Component, ICachedReport {
        
        public CachedRepAspirantes() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RepAspirantes rpt = new RepAspirantes();
            rpt.Site = this.Site;
            return rpt;
        }
