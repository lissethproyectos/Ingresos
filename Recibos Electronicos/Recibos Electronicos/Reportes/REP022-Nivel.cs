...
namespace Recibos_Electronicos.Reportes {
    ...
    public class REP022_Nivel : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Recibos_Electronicos.Reportes.REP022-Nivel.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREP022_Nivel : Component, ICachedReport {
        
        public CachedREP022_Nivel() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            REP022_Nivel rpt = new REP022_Nivel();
            rpt.Site = this.Site;
            return rpt;
        }
