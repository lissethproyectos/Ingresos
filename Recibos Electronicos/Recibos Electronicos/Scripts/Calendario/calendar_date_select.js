...
//        var anio1 = document.getElementById('ctl00_txtEjercicio').value;
//        alert(anio1);
        ...
        var arraySelects = document.getElementsByClassName('year');
        for (var i = 0; i < arraySelects.length; i++) {            
            arraySelects[i].style.display = 'none';
        }

        var arraySelectsNext = document.getElementsByClassName('next');
        for (var i = 0; i < arraySelectsNext.length; i++) {
            arraySelectsNext[i].style.display = 'none';
        }

        var arraySelectsPrev = document.getElementsByClassName('prev');
        for (var i = 0; i < arraySelectsPrev.length; i++) {
            arraySelectsPrev[i].style.display = 'none';
        }

        var arraySelectscds_buttons = document.getElementsByClassName('cds_buttons');
        for (var i = 0; i < arraySelectscds_buttons.length; i++) {
            arraySelectscds_buttons[i].style.display = 'none';
        }
