            ...
            <asp:MultiView ID="mltViewFacturas" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddlStatus" runat="server" Width="100%" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" AutoPostBack="True" CssClass="btn btn-primary dropdown-toggle">
                                        </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="grdDatosFactura" runat="server" AutoGenerateColumns="False" CellPadding="3" CssClass="sem table table-striped table-bordered table-hover" DataKeyNames="Id_Fact" EmptyDataText="No existen facturas, para el rango de fecha especificado..." OnPageIndexChanging="grdDatosFactura_OnPageIndexChanging" OnSelectedIndexChanged="grdDatosFactura_SelectedIndexChanged" PageSize="15" Width="100%" OnRowDeleting="grdDatosFactura_RowDeleting" ShowHeaderWhenEmpty="True">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linkBttnBitacora" runat="server" OnClick="linkBttnBitacora_Click"><i class="fa fa-clock-o fa-2x" aria-hidden="true"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                ...
                                                <asp:GridView ID="grdDatosFacturaEfect" runat="server" AutoGenerateColumns="False" CellPadding="3" CssClass="sem table table-striped table-bordered table-hover" DataKeyNames="Id_Fact" EmptyDataText="No existen facturas, para el rango de fecha especificado..." OnPageIndexChanging="grdDatosFactura_OnPageIndexChanging" OnRowDeleting="grdDatosFactura_RowDeleting" OnSelectedIndexChanged="grdDatosFacturaEfect_SelectedIndexChanged" PageSize="15" ShowHeaderWhenEmpty="True" Width="100%">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="FACT_RECEPTOR_RFC" HeaderText="RFC" />
                                                        <asp:BoundField DataField="FACT_NOMBRE" HeaderText="Beneficiario Factura" SortExpression="NOMBRE">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="FACT_FECHA_FACTURA" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha Pago" SortExpression="FECHA_FACTURA">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="FACT_FOLIO" HeaderText="Folio" SortExpression="FOLIO">
                                                        ...
                                                        <asp:BoundField DataField="FACT_IMPUESTO_TASA" HeaderText="Iva">
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="FACT_SUBTOTAL" HeaderText="SubTotal" />
                                                        <asp:BoundField DataField="FACT_TOTAL" DataFormatString="{0:C}" HeaderText="Importe" ItemStyle-HorizontalAlign="Right" SortExpression="Importe">
                                                            <HeaderStyle HorizontalAlign="Right" />
                                                        ...
                                                        <asp:TemplateField HeaderText="# Dias Status">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("FACT_DIAS_SOLICITUD") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Status">
                                                            <HeaderTemplate>
                                                                <asp:LinkButton ID="linkBttnAgregarReg0" runat="server" CssClass="btn btn-grey" OnClick="linkBttnAgregarReg_Click" ValidationGroup="New">Agregar</asp:LinkButton>
                                                            </HeaderTemplate>
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSol0" runat="server" Font-Bold="True" Font-Size="8" Text='<%# Bind("FACT_DESC_STATUS_SOLICITUD") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="linkBttnEditar0" runat="server" CausesValidation="false" CommandName="Select" Visible='<%# Bind("VISIBLE1") %>'><i aria-hidden="true" class="fa fa-pencil fa-2x"></i></asp:LinkButton>
                                                                <asp:LinkButton ID="linkBttnFactura" runat="server" CausesValidation="false" Visible='<%# Bind("VISIBLE2") %>' OnClick="linkBttnFactura_Click"><i aria-hidden="true" class="fa fa-file fa-2x"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:TemplateField HeaderText="RECHAZADO">
                                                            <ItemTemplate>
                                                                <asp:Image ID="imgRechazado3" runat="server" ImageUrl='<%# Bind("Ruta") %>' />
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" Width="20px" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="DOCUMENTOS">
                                                            <ItemTemplate>
                                                                <asp:Button ID="bttnDoctos0" runat="server" CssClass="btn btn-blue-grey" OnClick="bttnDoctos_Click" Text="Ver" />
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Center" Width="20px" />
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="FACT_DIAS_SOLICITUD" />
                ...
                <asp:View ID="Facturas" runat="server">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col">
                                <ajaxToolkit:TabContainer ID="tabFacturas" runat="server" ActiveTabIndex="2" Width="100%" Height="614px" CssClass="ajax__tab_xp">
                                    <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                                        <HeaderTemplate>
                                            <i class="fa fa fa-file fa-2x" aria-hidden="true"></i>&nbsp;Información de Factura
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="input-group-append">
                                                                <span class="input-group-text_buscar" id="basic-addon2">
                                                                    <asp:LinkButton ID="linkBttnRFC" CssClass="btn btn-primary" runat="server"><i class="fa fa-search" aria-hidden="true"></i> Buscar</asp:LinkButton>
                                    ...
                                    <ajaxToolkit:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3" Width="100%">
                                        <HeaderTemplate>
                                            <i class="fa fa-cog fa-2x" aria-hidden="true"></i>&nbsp;Detalle
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                                            ...
                                                            <div id="accordion" role="tablist" aria-multiselectable="true">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-1">
                                                                                        <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                                                            <ContentTemplate>
                                                                                                <asp:CheckBox ID="chkIvaDes" runat="server" AutoPostBack="True" Text="¿Con IVA desglozado?" onClick="Collapse1(this);" />
                                                                                            </ContentTemplate>
                                                                                        </asp:UpdatePanel>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div class="card" id="collapse3" runat="server">
                                                                    <div class="card-header" role="tab" id="headingTres">
                                                                        <div class="mb-0">
                                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTres" aria-expanded="false" aria-controls="collapseTres" class="collapsed">
                                                                                <i class="fa fa-file-text-o" aria-hidden="true"></i>
                                    ...
                                    <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="Imagen de la Factura">
                                        <HeaderTemplate>
                                            <i class="fa fa-upload fa-2x" aria-hidden="true"></i>&nbsp;Archivos
                                        </HeaderTemplate>
                                        <ContentTemplate>
...
<%--    <asp:HiddenField ID="hddnDoctos" runat="server" />
    ...
    <div class="modal fade" id="modalFacturas" tabindex="-1" role="dialog" aria-labelledby="modalFact" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modFacturas">Facturas</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript"> 
        ...
        function Collapse1(checkboxElem) {
            alert("paso");
