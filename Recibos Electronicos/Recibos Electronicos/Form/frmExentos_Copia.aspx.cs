...
{
    public partial class frmExentos_Copia : System.Web.UI.Page
    {
        #region <Variables>
        ...
        private void HideColumns(GridView grdView)
        {
            ...
            grdView.HeaderRow.Cells[13].Visible = (SesionUsu.Usu_Central=="S") ? true : false; //(usuAdmin.Length != 0) ? true : false;
        ...
        protected void btnGuardar_C_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Verificador == "0")
                {
                    ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "modal", "mostrar_modal( 1, 'Se ha cancelado el descuento correctamente');", true); //lblMsj.Text = "Se ha cancelado el descuento correctamente";
                    SesionUsu.Row = -1;
                    CargarGrid();
                    modalCancelar.Hide();
                }
