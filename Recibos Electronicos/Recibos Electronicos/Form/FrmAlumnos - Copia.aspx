                        ...
                        <asp:Panel ID="pnlPrincipal" runat="server">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td class="style18" rowspan="5" valign="top">
                                        <div class="cuadro_botones">
                                        <asp:ImageButton ID="imgBttnNuevo" runat="server" 
                                            ImageUrl="http://sysweb.unach.mx/resources/imagenes/nuevo.png" OnClick="imgBttnNuevo_Click" />
                                            </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style10" valign="top">
                                        <asp:ImageButton ID="imgBttnBuscar" runat="server" ImageUrl="http://sysweb.unach.mx/resources/imagenes/buscar.png" OnClick="imgBttnBuscar_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1" align="center" colspan="4">
                                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel1">
                                            <progresstemplate>
                                                <asp:Image ID="Image86" runat="server" AlternateText="Espere un momento, por favor.." Height="50px" ImageUrl="http://sysweb.unach.mx/resources/imagenes/ajax_loader_gray_512.gif" ToolTip="Espere un momento, por favor.." />
                                            </progresstemplate>
                                        </asp:UpdateProgress>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" class="style22" colspan="4">
                                        <div class="cuadro_botones">
                                            <asp:ImageButton ID="imgBttnReporte" runat="server" ImageUrl="http://sysweb.unach.mx/resources/imagenes/pdf.png" OnClick="imgBttnReporte_Click" />
                                            &nbsp;<asp:ImageButton ID="imgBttnExportar" runat="server" ImageUrl="http://sysweb.unach.mx/resources/imagenes/excel.png" OnClick="imgBttnExportar_Click" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            <td align="center">
                <asp:UpdateProgress ID="UpdateProgress2" AssociatedUpdatePanelID="UpdatePanel2" runat="server">
                    <ProgressTemplate>
                        <asp:Image ID="Image87" runat="server" Height="50px" ImageUrl="http://sysweb.unach.mx/resources/imagenes/ajax_loader_gray_512.gif" AlternateText="Espere un momento, por favor.." 
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td align="center" class="style5" colspan="3">
                                        <asp:Button ID="btnGuardar" runat="server" CssClass="btn" Height="45px" Text="GUARDAR" OnClick="btnGuardar_Click" ValidationGroup="guardar" TabIndex="15" />
                                        &nbsp;<asp:Button ID="btnCancelar" runat="server" CssClass="btn2" Height="45px"
        ...
        <tr>
            <td align="center">
                    ...
                    <asp:UpdateProgress ID="UpdateProgress3" runat="server" AssociatedUpdatePanelID="UpdatePanel3_">
                        <ProgressTemplate>
                            <asp:Image ID="Image88" runat="server" Height="50px" ImageUrl="http://sysweb.unach.mx/resources/imagenes/ajax_loader_gray_512.gif" AlternateText="Espere un momento, por favor.." 
                                ToolTip="Espere un momento, por favor.." />
                        </ProgressTemplate>
                    </asp:UpdateProgress>
