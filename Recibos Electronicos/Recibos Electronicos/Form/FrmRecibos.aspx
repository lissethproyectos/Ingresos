        ...
        <tr>
            <td align="center">
                <asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel3" runat="server">
                    <ProgressTemplate>
                        <asp:Image ID="imgModRec" runat="server" Height="50px" ImageUrl="https://sysweb.unach.mx/resources/imagenes/ajax_loader_gray_512.gif" ToolTip="Espere un momento, por favor.." AlternateText="Espere un momento, por favor.." />
                    </ProgressTemplate>
                </asp:UpdateProgress>
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        <asp:GridView ID="grvFacturas" runat="server" AllowPaging="True"
                                            ...
                                            EmptyDataText="No se encontró el recibo." CssClass="mGrid" Width="100%" OnRowDeleting="grvFacturas_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:CommandField SelectText="Editar" ShowSelectButton="True" ButtonType="Image" SelectImageUrl="~/Imagenes/edit.png" HeaderText="Editar">
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td class="style12" colspan="2" align="center">
                                        <table width="100%">
                                            <tr>
                                                <td align="left" class="auto-style8" valign="top">&nbsp;</td>
                                                <td align="left" class="auto-style6" valign="top">&nbsp;</td>
                                                        ...
                                                        <ContentTemplate>
                                                            ...
                                                            <table style="width: 100%;">
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;<asp:ImageButton ID="imgBttnAgregarConcepto0" runat="server" ImageUrl="https://sysweb.unach.mx/resources/imagenes/nuevo.png" OnClick="imgBttnAgregarConcepto0_Click" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                    ...
                                    <td colspan="2" align="center">
                                        <asp:Panel ID="pnlAgregaConceptos" runat="server" BackColor="White"
                                            ...
                                            <table width="90%">
                                                ...
                                                <tr>
                                                    <td align="center" colspan="5" width="35%">&nbsp;</td>
                                                </tr>
                                                <tr>
