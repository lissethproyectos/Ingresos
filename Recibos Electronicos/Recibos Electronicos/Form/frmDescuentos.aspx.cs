...
{
    public partial class frmDescuentos : System.Web.UI.Page
    {
        #region <Variables>
        ...
        private List<DetConcepto> GetListConceptos()
        {
            try
            {
                ...
                CNDetDesc.ConsultarCatConceptoDescuento("UNACH", ObjConcepto, ddlSubTipo.SelectedValue, ref List);
                return List;
            }
            catch (Exception ex)
            {
        ...
        private List<Alumno> GetList()
        {
            try
            {
                ...
                CNAlumno.ConsultarAlumnoDescuento("UNACH", ref ObjAlumno, "T", txtReferencia.Text, ref List);
                return List;
            }
            catch (Exception ex)
            {
        ...
        private void HideColumns(GridView grdView)
        {
            ...
            //grdView.HeaderRow.Cells[13].Visible = (usuAdmin.Length != 0) ? true : false;
            ...
            foreach (GridViewRow row in grdView.Rows)
            {
                ...
                //row.Cells[13].Visible = (usuAdmin.Length != 0) ? true : false;
                row.Cells[13].Visible = (SesionUsu.Usu_Central == "S") ? true : false;
        ...
        private void GuardarDatos()
        {
            if (grvConceptos.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    {
                        CNAlumno.AlumnoInsertarDescuentoOld(ref ObjAlumno, ref Verificador);
                        if (Verificador == "0")
                        {
                    ...
                    {
                        CNAlumno.AlumnoEditarDescuentoOld(ref ObjAlumno, ref Verificador);
                        if (Verificador == "0")
                        {
                            ListDetConcepto = (List<DetConcepto>)Session["Conceptos"];
                    ...
                    {
                        //lblMsjGuardar.Text = "Los datos se guardaron correctamente.";
                        ...
                        lblMsj.Text = "Posible registro duplicado.. Error(" + Verificador + ")" + " " + VerificadorOficios;
            ...
            {
                lblMsj.Text = "Se debe agregar por lo menos un concepto.";
            }
        }
        private void Nuevo()
        {
        ...
        protected void imgBttnBuscarMat_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    lblMsj.Text = "Dato no encontrado, si deseas registralo dar click por única vez.";
                    Registrar.Visible = true;
                }
            }
            catch (Exception ex)
        ...
        protected void bttnAgregaOficio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (FileOficio.HasFile)
                {
                    ...
                    {
                        lblMsj.Text = "Solo se permiten formatos: PDF, JPG, GIF y PNG";
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void btnGuardar_C_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CNAlumno.AlumnoEliminarDescuento(ObjAlumno, ref Verificador);
                if (Verificador == "0")
                {
                    lblMsj.Text = "Se ha cancelado el descuento correctamente";
                    SesionUsu.Row = -1;
                    CargarGrid();
                    modalCancelar.Hide();
                }
        ...
        protected void imgBttnReporte_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //ScriptManager.RegisterStartupScript(this, this.GetType(), UniqueID, "VerReporteExentos('REPA033','" + ddlCiclo.SelectedValue + "','" + ddlDependencia.SelectedValue + "','" + ddlStatus_Ini.SelectedValue + "');", true);
        ...
        {
            //MultiView1.ActiveViewIndex = 0;
            //ScriptManager.RegisterStartupScript(this, this.GetType(), UniqueID, "VerReporteExentos_Excel('REPA04','" + ddlCiclo.SelectedValue + "','" + ddlDependencia.SelectedValue + "','" + ddlStatus_Ini.SelectedValue + "');", true);
        ...
        protected void imgBttnReporteDesc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            GridViewRow row = (GridViewRow)cbi.NamingContainer;
            grvAlumnos.SelectedIndex = row.RowIndex;
            string ruta = "../Reportes/VisualizadorCrystal.aspx?Tipo=REPA04&idFact=" + grvAlumnos.SelectedRow.Cells[0].Text;
            string _open = "window.open('" + ruta + "', '_newtab');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
