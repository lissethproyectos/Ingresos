                                                                                                                ...
                                                                                                                <asp:GridView ID="grdDatosFactura" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="mGrid mGrid10px" DataKeyNames="ID_FACT" EmptyDataText="No existen registros." OnPageIndexChanging="grdDatosFactura_OnPageIndexChanging" OnSelectedIndexChanged="grdDatosFactura_SelectedIndexChanged" Width="100%" ShowHeaderWhenEmpty="True" ShowFooter="True">
                                                                                                                    <Columns>
                                                                                                                        ...
                                                                                                                        <asp:TemplateField>
                                                                                                                            ...
                                                                                                                            <HeaderTemplate><asp:Button ID="bttnGenerarRef" runat="server" CssClass="btn btn-blue-grey" Font-Size="XX-Small" OnClick="bttnGenerarRef_Click" Text="GENERAR REFERENCIA" ValidationGroup="GenRef" Width="144px" /></HeaderTemplate><ItemTemplate><asp:Button ID="bttnReimprimir" runat="server" CssClass="btn btn-primary" Font-Size="X-Small" Text="Pagar" Visible='<%# Bind("VISIBLE1") %>' Width="56px" OnClick="bttnReimprimir_Click" />&nbsp;<asp:Button ID="bttnEliminar" runat="server" CssClass="btn btn-danger" Font-Size="X-Small" OnClick="bttnEliminar_Click" Text="Eliminar" Visible='<%# Bind("VISIBLE1") %>' Width="65px" OnClientClick="return confirm('¿Eliminar registro?');" />
...
<%--                                                                                            <asp:BoundField HeaderText="Costo" DataField="Costo" DataFormatString="{0:c}" />--%>
                                                                                                                    ...
                                                                                                                    Números</asp:RegularExpressionValidator>
                                                                                                                        ...
                                                                                                                        <asp:TemplateField><FooterTemplate>&nbsp;&nbsp;<asp:Label ID="lblTotal0" runat="server" Font-Bold="True" Font-Size="Medium" Text="TOTAL:"></asp:Label><asp:Label ID="lblTotal" runat="server" Font-Bold="True" Font-Size="Medium" Text="0"></asp:Label></FooterTemplate><HeaderTemplate><asp:Button ID="bttnPagar" runat="server" CssClass="btn btn-blue-grey" Font-Size="X-Small" OnClick="bttnPagar_Click" Text="PAGAR" Enabled="False" ValidationGroup="Cliente" ToolTip="Tienes que asignar un monto para poder habilitar el botón PAGAR." /></HeaderTemplate><ItemTemplate><asp:LinkButton ID="linkEliminar" runat="server" CommandName="Delete">Eliminar</asp:LinkButton></ItemTemplate><FooterStyle HorizontalAlign="Right" /><HeaderStyle HorizontalAlign="Center" />
