                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="2">
                                                                                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                                                                            <ContentTemplate>
                                                                                                                <asp:GridView ID="grdDatosFactura" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="mGrid mGrid10px" DataKeyNames="ID_FACT" EmptyDataText="No existen registros." OnPageIndexChanging="grdDatosFactura_OnPageIndexChanging" OnSelectedIndexChanged="grdDatosFactura_SelectedIndexChanged" Width="100%" ShowHeaderWhenEmpty="True" ShowFooter="True">
                                                                                                                    <Columns>
                                                                                                                        ...
                                                                                                                        <asp:BoundField DataField="FACT_FECHA_FACTURA" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha" SortExpression="FECHA_FACTURA"><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                                                                                                        ...
                                                                                                                        <asp:BoundField DataField="FACT_NOMBRE" HeaderText="Nombre" SortExpression="NOMBRE"><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                                                                                                        <asp:TemplateField><ItemTemplate><asp:Button ID="bttnDetalle" runat="server" CssClass="btn btn-info" Font-Size="X-Small" OnClick="bttnDetalle_Click" Text="Ver Detalle" Width="87px" /></ItemTemplate><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
                                                                                                                        <asp:TemplateField>
                                                                                                                            <FooterTemplate>
                                                                                                                            ...
                                                                                                                            <HeaderTemplate><asp:Button ID="bttnGenerarRef" runat="server" CssClass="btn btn-blue-grey" Font-Size="XX-Small" OnClick="bttnGenerarRef_Click" Text="NUEVA REFERENCIA" ValidationGroup="GenRef" Width="144px" /></HeaderTemplate><ItemTemplate><asp:Button ID="bttnReimprimir" runat="server" CssClass="btn btn-primary" Font-Size="X-Small" Text="Pagar" Visible='<%# Bind("VISIBLE1") %>' Width="56px" OnClick="bttnReimprimir_Click" />&nbsp;<asp:Button ID="bttnEliminar" runat="server" CssClass="btn btn-danger" Font-Size="X-Small" OnClick="bttnEliminar_Click" Text="Eliminar" Visible='<%# Bind("VISIBLE1") %>' Width="65px" OnClientClick="return confirm('¿Eliminar registro?');" />
                                                                                                                            <asp:Button ID="bttnVerRecibo" runat="server" CssClass="btn btn-primary" Font-Size="X-Small" Text="Ver Recibo" Visible='<%# Bind("VISIBLE2") %>' Width="118px" OnClick="bttnVerRecibo_Click" /></ItemTemplate><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="auto-style17" colspan="3">
                                                                                                                        <asp:GridView ID="grvDetPago" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="mGrid" EmptyDataText="No se encontro ningún registro" Width="100%">
                                                                                                                            <Columns>
                                                                                                                                <asp:BoundField DataField="No_Inventario" HeaderText="# Inventario"><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                                                                                                                <asp:BoundField DataField="Descripcion" HeaderText="Descripción"><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Left" Width="70%" /></asp:BoundField>
                                                                                                                                <asp:BoundField DataField="Total" HeaderText="Importe" DataFormatString="{0:C}"><HeaderStyle HorizontalAlign="Right" /><ItemStyle HorizontalAlign="Right" /></asp:BoundField>
                                                                                                                            </Columns>
                                                                                                                            <FooterStyle CssClass="enc" />
                                                                                                                            <HeaderStyle CssClass="enc" />
                                                                                                                            <PagerStyle CssClass="enc" HorizontalAlign="Center" />
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td colspan="2"> 
                                <table class="auto-style21">
                                    <tr valign="top">
                                        <td colspan="2">
                                            <asp:Label ID="lblLeyDependencia" runat="server" Font-Bold="True" Font-Size="Large"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                <ContentTemplate>
                                                    <%--<asp:DropDownList ID="DDLTipoVenta" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDLTipoVenta_SelectedIndexChanged">
                                                        <asp:ListItem Value="0">--Seleccionar--</asp:ListItem>
                                                        <asp:ListItem Value="ACT">Activos Biologicos</asp:ListItem>
                                                        <asp:ListItem Value="000">Varios Productos</asp:ListItem>
                                                        <asp:ListItem Value="LBT">Consultas</asp:ListItem>
                                                    </asp:DropDownList>--%>
                                                    <customControl:GroupDropDownList ID="DDLTipoVenta" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDLTipoVenta_SelectedIndexChanged">
                                            ...
                                            <table style="width:100%;">
                                                <tr>
                                                    <td class="auto-style7" valign="top">
                                                        <asp:TextBox ID="txtClaveSysweb" runat="server"></asp:TextBox>
                                                    </td>
                                                    <td valign="top">
                                                        <asp:ImageButton ID="imgBttnBuscarCliente" runat="server" Height="35px" ImageUrl="https://sysweb.unach.mx/resources/imagenes/buscar.png" ToolTip="Busca # de Cliente" onclick="imgBttnBuscarCliente_Click" ValidationGroup="Cliente" Width="35px" />
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                            <ContentTemplate>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtClaveSysweb" ErrorMessage="* El número del cliente es requerido." ValidationGroup="Cliente">* El número del cliente es requerido.</asp:RequiredFieldValidator>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </td>
                                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label ID="lblClienteNombre" runat="server" CssClass="mensaje_naranja" Font-Bold="True" Width="50%">-----</asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                                                                                                    <td colspan="2" class="derecha">
                                                                                                        <%--<asp:UpdateProgress ID="updLoadBusca" runat="server" AssociatedUpdatePanelID="updPnlBusca">
                                                                                                            <progresstemplate>
                                                                                                        ...
                                                                                                        <ContentTemplate>--%>
                                                                                                            <asp:GridView ID="grvInventario" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="mGrid" EmptyDataText="No hay productos/servicios registrados" OnPageIndexChanging="grvInventario_PageIndexChanging" OnSelectedIndexChanged="grvInventario_SelectedIndexChanged" Width="100%">
                                                                                                                ...
                                                                                                                <Columns>
                                                                                                                    ...
                                                                                                                    <asp:BoundField DataField="Costo" HeaderText="Costo" ><HeaderStyle HorizontalAlign="Right" /><ItemStyle HorizontalAlign="Right" /></asp:BoundField>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="2" align="center">
                                                                                                        <%--<asp:UpdateProgress ID="updLoadInventarioAgregado" runat="server" AssociatedUpdatePanelID="updInventarioAgregado">
                                                                                                            <progresstemplate>
                                    <asp:Image ID="imgddlTipo0" runat="server" AlternateText="Espere un momento, por favor.." Height="50px" ImageUrl="https://sysweb.unach.mx/resources/imagenes/ajax_loader_gray_512.gif" ToolTip="Espere un momento, por favor.." />
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="2">
                                                                                                        <%--<asp:UpdatePanel ID="updInventarioAgregado" runat="server">
                                                                                                            <ContentTemplate>--%>
...
<%--                                                                                            <asp:BoundField HeaderText="Costo" DataField="Costo" DataFormatString="{0:c}" />--%>
                                                                                                                        <asp:BoundField DataField="No_Inventario" HeaderText="# Inventario" ReadOnly="True"><HeaderStyle HorizontalAlign="Left" /><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                                                                                                        ...
                                                                                                                        <asp:TemplateField HeaderText="Unidad de Medida"><ItemTemplate><asp:DropDownList ID="DDLUnidadMedida" runat="server" OnSelectedIndexChanged="DDLUnidadMedida_SelectedIndexChanged" Enabled="False"><asp:ListItem Value="0">--Seleccionar--</asp:ListItem><asp:ListItem Value="1">Kilo(s)</asp:ListItem><asp:ListItem Value="2">Litro(s)</asp:ListItem><asp:ListItem Value="3">Pieza(s)</asp:ListItem><asp:ListItem Value="4">Servicio(s)</asp:ListItem></asp:DropDownList></ItemTemplate><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
                                                                                                                        <asp:TemplateField HeaderText="Cantidad"><ItemTemplate><asp:TextBox ID="txtCantidad" runat="server" Enabled="False">1</asp:TextBox><br /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCantidad" ErrorMessage="*Requerido">*Requerido</asp:RequiredFieldValidator>
                                                                                                                    ...
                                                                                                                    Números</asp:RegularExpressionValidator>
                                                                                                                        ...
                                                                                                                        <asp:TemplateField HeaderText="Total"><ItemTemplate><asp:Label ID="lblTotU" runat="server" Text="0"></asp:Label></ItemTemplate></asp:TemplateField>
                                                                                                                        <asp:CommandField ShowEditButton="True" />
                                                                                                                        <asp:TemplateField><FooterTemplate>&nbsp;&nbsp;<asp:Label ID="lblTotal0" runat="server" Font-Bold="True" Font-Size="Medium" Text="TOTAL:"></asp:Label><asp:Label ID="lblTotal" runat="server" Font-Bold="True" Font-Size="Medium" Text="0"></asp:Label></FooterTemplate><HeaderTemplate><asp:Button ID="bttnPagar" runat="server" CssClass="btn btn-blue-grey" Font-Size="X-Small" OnClick="bttnPagar_Click" Text="GENERAR REFERENCIA" Enabled="False" ValidationGroup="Cliente" ToolTip="Tienes que asignar un monto para poder habilitar el botón PAGAR." /></HeaderTemplate><ItemTemplate><asp:LinkButton ID="linkEliminar" runat="server" CommandName="Delete">Eliminar</asp:LinkButton></ItemTemplate><FooterStyle HorizontalAlign="Right" /><HeaderStyle HorizontalAlign="Center" />
                    ...
                    <tr>
                        <td colspan="3">
                                                                                                        ...
                                                                                                        <asp:Panel ID="pnlForma_Pago" runat="server" CssClass="TituloModalPopupMsg" Width="50%">
                                                                                                            <table style="width: 100%;">
                                                                                                                <tr>
                                                                                                                    <td class="auto-style16" colspan="3">
                                                                                                                        <div class="titulo_pop">
                                                                                                                            Métodos de Pago</div></td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td width="20%" align="right">
                                                                                                                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="REFERENCIA:"></asp:Label>
                                                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="center" width="60%" class="auto-style26">
                                                                                                                        <table style="width:100%;">
                                                                                                                            <tr>
                                                                                                                                <td>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td style="font-weight: bold; color: #666666;">PAGO EN EFECTIVO</td>
                                                                                                                                <td align="center" style="font-weight: bold; color: #666666;"><span style="color: rgb(102, 102, 102); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, &quot;Noto Sans&quot;, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: -webkit-center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">TARJETA DE</span><br style="box-sizing: border-box; color: rgb(102, 102, 102); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, &quot;Noto Sans&quot;, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: -webkit-center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial;" />
                                                                                                                                    <span style="color: rgb(102, 102, 102); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, &quot;Noto Sans&quot;, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;, &quot;Segoe UI Symbol&quot;, &quot;Noto Color Emoji&quot;; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 700; letter-spacing: normal; orphans: 2; text-align: -webkit-center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">CRÉDITO Ó DÉBITO/CLABE INTERBANCARIA</span></td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    <td width="20%" align="center">&nbsp;</td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td width="20%">&nbsp;</td>
                                                                                                                    <td align="center" class="auto-style26" width="60%">&nbsp;</td>
                                                                                                                    <td width="20%">&nbsp;</td>
                                                                                                                </tr>
                                                                                                                <tr>
                                                                                                                    <td width="20%">&nbsp;</td>
