                                                            ...
                                                            <ContentTemplate>
                                                                <asp:GridView ID="grdDatosFactura" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="mGrid mGrid10px" DataKeyNames="ID_FACT" EmptyDataText="No existen registros." OnPageIndexChanging="grdDatosFactura_OnPageIndexChanging" OnSelectedIndexChanged="grdDatosFactura_SelectedIndexChanged" Width="100%" ShowHeaderWhenEmpty="True" ShowFooter="True">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="bttnDetalle" runat="server" CssClass="btn btn-info" Font-Size="X-Small" OnClick="bttnDetalle_Click" Text="Ver Detalle" Width="87px" />
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="bttnReimprimir" runat="server" CssClass="btn btn-primary" Font-Size="X-Small" Text="Pagar" Visible='<%# Bind("VISIBLE1") %>' Width="56px" OnClick="bttnReimprimir_Click" />&nbsp;<asp:Button ID="bttnEliminar" runat="server" CssClass="btn btn-danger" Font-Size="X-Small" OnClick="bttnEliminar_Click" Text="Eliminar" Visible='<%# Bind("VISIBLE1") %>' Width="65px" OnClientClick="return confirm('¿Eliminar registro?');" />
                                                                                <asp:Button ID="bttnVerRecibo" runat="server" CssClass="btn btn-primary" Font-Size="X-Small" Text="Ver Recibo" Visible='<%# Bind("VISIBLE2") %>' Width="118px" OnClick="bttnVerRecibo_Click" />
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" />
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
