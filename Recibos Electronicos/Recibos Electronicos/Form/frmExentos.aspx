                                ...
                                <asp:UpdatePanel ID="updPnlTabs" runat="server">
                                    <ContentTemplate>
                                        <div class="container-fluid">
                                            <%--<div class="row">
                                                <div class="col">
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist" runat="server">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" runat="server" data-toggle="tab" href="#alumno" role="tab" aria-controls="home"><i class="fa fa-user fa-lg" aria-hidden="true"></i>&nbsp;Datos del Alumnos/Cliente</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" runat="server" data-toggle="tab" href="#exencion" role="tab" aria-controls="exencion"><i class="fa fa-sticky-note fa-lg" aria-hidden="true"></i>&nbsp;Datos de la Exención</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="nav-pago-cie" data-toggle="tab" href="#pago-cie" role="tab" aria-controls="pago-cie"><i class="fa fa-upload fa-lg" aria-hidden="true"></i>&nbsp;Oficio(s)</a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="exencion" role="tabpanel" aria-labelledby="exencion-tab">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdMatricula" runat="server">
                                                                                <ContentTemplate>
                                                                                    <span class="input-group-addon">
                                                                                        <asp:LinkButton ID="linkBttnBuscar" runat="server" CssClass="btn btn-info" OnClick="linkBttnBuscar_Click">
