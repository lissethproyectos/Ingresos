        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlContenor" runat="server">
                    <asp:Panel ID="pnlRangoFecha" runat="server">
                    <div class="row">
                        <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:TextBox ID="txtReferencia" runat="server" CssClass="box" OnTextChanged="txtReferencia_TextChanged" PlaceHolder="Referencia, folio ó nombre" Visible="true" Width="100%"></asp:TextBox>
                    </div>
                    <div class="col-md-1">
            ...
            <div class="col">
                <asp:Panel ID="pnlRepRetenciones" runat="server" CssClass="TituloModalPopupMsg" Width="40%">
                    <table width="100%">
                        ...
                        <tr>
                            <td align="left">&nbsp;</td>
                            <td align="center">&nbsp;<asp:UpdatePanel ID="UpdatePanel43" runat="server">
                                <ContentTemplate>
