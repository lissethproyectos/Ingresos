...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 Ayuda</a>
                ...
                <%--<p class="note note-warning" style="font-size: 14px">
                    <strong>PAGO EN VENTANILLA. </strong>
                    <span id="ctl00_MainContent_lblTitulo0">El COMPROBANTE OFICIAL estara disponible al siguiente dia hábil, si el pago se realizó en Sábado ó Domingo, el COMPROBANTE OFICIAL estará disponible a partir del Martes inmediato, para días inhábiles, aplica el mismo criterio; el COMPROBANTE OFICIAL estará disponible un dia después al día hábil inmediato.
                    </span>
                </p>--%>
            </div>
        </div>
