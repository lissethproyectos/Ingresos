...
Comprobantes Electrónicos de pagos realizados a través de una ficha referenciada, por medio de tdc, debito, clabe, cie o ventanilla bancaria.                        <br />
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="Default.aspx?mnu=ADMIN" class="btn btn-warning btn-rounded">Continuar</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
        ...
        <br />
        <div class="row"><div class="col alert alert-warning font-weight-bold">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lblMsg_Observaciones" runat="server"></asp:Label>
                </ContentTemplate>
            </asp:UpdatePanel>
                         </div></div>
    </div>
